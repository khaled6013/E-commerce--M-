...
const CartD = () => {
  ...
  const grandTotal = totalPrice > 0 ? totalPrice + shippingCost : 0;
                ...
                <div className="flex flex-col lg:flex-row gap-10">
                    <div className="lg:w-2/3 w-full">
                                    ...
                                    <div key={index} className="flex flex-col sm:grid sm:grid-cols-12 gap-4 items-center border-b border-[#E1E1E4] pb-6 last:border-0">
                                        <div className="col-span-6 w-full flex items-center gap-4">
                                            <div className="relative group">
                                                <div className="w-20 h-20 bg-[#E1E1E4] rounded-sm overflow-hidden flex justify-center items-center relative">
                                                    ...
                                                    <div className="absolute top-0 right-0 w-4 h-4 bg-black text-white flex justify-center items-center rounded-full cursor-pointer opacity-0 group-hover:opacity-100 transition-opacity text-[10px]">
                                                        <RxCross2 />
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="col-span-2 w-full flex justify-between sm:justify-center">
                                            ...
                                            <div className="flex items-center bg-[#F0EFF2]">
                                                <button className="px-2 py-1 text-[#BEBFC2] hover:text-black">-</button>
                                                <input 
                                                    type="text" 
                                                    value={item.quantity} 
                                                    readOnly
                        ...
                        <div className="flex justify-between mt-8">
                             ...
                             <button className="bg-[#FB2E86] text-white font-josefin text-[16px] px-6 py-2 rounded-xs hover:bg-[#F94C9B] transition-colors">Clear Curt</button>
                        </div>
                    </div>
                        ...
                        <div className="flex flex-col gap-8">
                            ...
                            <div className="bg-[#F4F4FC] p-8 rounded-[3px]">
                                ...
                                <div className="flex justify-between items-center border-b border-[#E8E6F1] pb-3 mb-8">
                                    ...
                                    <span className="text-[#151875] font-lato text-[16px]">${grandTotal.toFixed(2)}</span>
                                </div>
                                ...
                                <Link to="#" className="block w-full text-center bg-[#19D16F] text-white font-lato font-bold text-[14px] py-3 rounded-[3px] hover:bg-[#15b35d] transition-colors">
                                    Proceed To Checkout
                                </Link>
                            </div>
                        </div>
