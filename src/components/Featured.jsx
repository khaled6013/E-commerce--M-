                        ...
                        <div key={index} className="px-3 pb-10 pt-2">
                            <div className="group relative shadow-[0_0_25px_0_rgba(0,0,0,0.05)] hover:shadow-[0_0_25px_0_rgba(0,0,0,0.2)] transition-all duration-300 bg-white">
                                ...
                                <div className="w-full h-59 bg-[#F6F7FB] flex justify-center items-center relative overflow-hidden">
                                    ...
                                    <img src={chair} alt="chair" className='w-32.5 sm:w-37.5 group-hover:scale-110 transition-all duration-300' />
                                    <button className="absolute bottom-4 left-[50%] -translate-x-[50%] bg-[#08D15F] text-white font-josefin text-[12px] px-4 py-2 rounded-sm opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-full group-hover:translate-y-0 hover:bg-[#07b552]">
                                        View Details
                                    </button>
                                </div>
                                <div className="bg-white group-hover:bg-[#2F1AC4] p-4 flex flex-col items-center gap-3 transition-colors duration-300 border-t border-transparent group-hover:border-[#2F1AC4]">
                                    <h3 className="font-josefin text-[18px] font-bold text-[#FB2E86] group-hover:text-white transition-colors">Cantilever chair</h3>
                                    ...
                                    <p className="font-josefin text-[14px] text-[#151875] group-hover:text-white transition-colors">Code - {item.code}</p>
